...
public Pokemon(string nombre, int salud, int ataque, int
defensa)
{
Nombre = nombre;
Salud = salud;
...
// Método para defenderse y reducir el daño del próximo
ataque
...
{
case 1:
jugadorPokemon = new Pokemon("Charmander", 50,
15, 5);
break;
case 2:
jugadorPokemon = new Pokemon("Squirtle", 50, 10,
10);
break;
case 3:
jugadorPokemon = new Pokemon("Bulbasaur", 50,
12, 8);
break;
default:
...
public void Batalla()
{
while (jugadorPokemon.Salud > 0 && enemigoPokemon.Salud
> 0)
{
